...
if(!empty($search)){
$sql = "SELECT tblvehicles.VehiclesTitle,tblbrands.BrandName,tblvehicles.PricePerDay,tblvehicles.FuelType,tblvehicles.ModelYear,tblvehicles.id,tblvehicles.SeatingCapacity,tblvehicles.VehiclesOverview,tblvehicles.Vimage1 from tblvehicles join tblbrands on tblbrands.id=tblvehicles.VehiclesBrand where tblvehicles.VehiclesTitle LIKE '%".$search."%' OR tblbrands.BrandName LIKE '%".$search."%' OR tblvehicles.VehiclesOverview LIKE '%".$search."%' OR tblvehicles.PricePerDay LIKE '%".$search."%' OR tblvehicles.FuelType LIKE '%".$search."%' OR tblvehicles.ModelYear LIKE '%".$search."%' OR tblvehicles.SeatingCapacity LIKE '%".$search."%'";
}else{
...
<div class="car-info-box"> <a href="vehical-details.php?vhid=<?php echo "{$result['id']}";?>"><img src="admin/img/vehicleimages/<?php echo "{$result['Vimage1']}";?>" class="img-responsive" alt="image" style="height: 220px;"></a>
<ul>
<li><i class="fa fa-car" aria-hidden="true"></i><?php echo "{$result['FuelType']}";?></li>
<li><i class="fa fa-calendar" aria-hidden="true"></i><?php echo "{$result['ModelYear']}";?> Mẫu</li>
<li><i class="fa fa-user" aria-hidden="true"></i><?php echo "{$result['SeatingCapacity']}";?> Người ngồi</li>
</ul>
</div>
<div class="car-title-m">
<h6><a href="vehical-details.php?vhid=<?php echo "{$result['id']}";?>"><?php echo "{$result['BrandName']}";?> , <?php echo "{$result['VehiclesTitle']}";?></a></h6>
